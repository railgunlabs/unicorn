...
static void ubuffer_append_u8(struct UBuffer *buf, const unichar *chars, unisize chars_count)
{
...
static void ubuffer_nullterminate_u8(struct UBuffer *buf)
{
    UChar8 *buffer = buf->storage; // cppcheck-suppress misra-c2012-11.5
    if (buffer != NULL)
    {
...
static void ubuffer_append_u16(struct UBuffer *buf, const unichar *chars, unisize chars_count, ByteSwap16 swap)
{
...
static void ubuffer_nullterminate_u16(struct UBuffer *buf, ByteSwap16 swap)
{
    UChar16 *buffer = buf->storage; // cppcheck-suppress misra-c2012-11.5
    if (buffer != NULL)
    {
...
static void ubuffer_append_u16be(struct UBuffer *buf, const unichar *chars, unisize chars_count)
{
    ubuffer_append_u16(buf, chars, chars_count, &unicorn_swap16_be);
}

static void ubuffer_nullterminate_u16be(struct UBuffer *buf)
{
    ubuffer_nullterminate_u16(buf, &unicorn_swap16_be);
}

static void ubuffer_append_u16le(struct UBuffer *buf, const unichar *chars, unisize chars_count)
{
    ubuffer_append_u16(buf, chars, chars_count, &unicorn_swap16_le);
}

static void ubuffer_nullterminate_u16le(struct UBuffer *buf)
{
    ubuffer_nullterminate_u16(buf, &unicorn_swap16_le);
}
#endif

#if defined(UNICORN_FEATURE_ENCODING_UTF32)
static void ubuffer_append_u32(struct UBuffer *buf, const unichar *chars, unisize chars_count, ByteSwap32 swap)
{
...
static void ubuffer_append_u32be(struct UBuffer *buf, const unichar *chars, unisize chars_count)
{
    ubuffer_append_u32(buf, chars, chars_count, &unicorn_swap32_be);
}

static void ubuffer_append_u32le(struct UBuffer *buf, const unichar *chars, unisize chars_count)
{
    ubuffer_append_u32(buf, chars, chars_count, &unicorn_swap32_le);
}

static void ubuffer_nullterminate_u32(struct UBuffer *buf)
{
    UChar32 *buffer = buf->storage; // cppcheck-suppress misra-c2012-11.5
    if (buffer != NULL)
    {
...
static void ubuffer_append_scalar(struct UBuffer *buf, const unichar *chars, unisize chars_count)
{
...
static void ubuffer_nullterminate_scalar(struct UBuffer *buf)
{
    unichar *buffer = buf->storage; // cppcheck-suppress misra-c2012-11.5
    if (buffer != NULL)
    {
...
{
#if defined(UNICORN_FEATURE_ENCODING_UTF8)
    static const struct UBufferDelegate ubuffer_u8 = {
        .append = &ubuffer_append_u8,
        .nullterminate = &ubuffer_nullterminate_u8,
    };
#endif

#if defined(UNICORN_FEATURE_ENCODING_UTF16)
    static const struct UBufferDelegate ubuffer_u16be = {
        .append = &ubuffer_append_u16be,
        .nullterminate = &ubuffer_nullterminate_u16be,
    };

    static const struct UBufferDelegate ubuffer_u16le = {
        .append = &ubuffer_append_u16le,
        .nullterminate = &ubuffer_nullterminate_u16le,
    };
#endif

#if defined(UNICORN_FEATURE_ENCODING_UTF32)
    static const struct UBufferDelegate ubuffer_u32be = {
        .append = &ubuffer_append_u32be,
        .nullterminate = &ubuffer_nullterminate_u32,
    };

    static const struct UBufferDelegate ubuffer_u32le = {
        .append = &ubuffer_append_u32le,
        .nullterminate = &ubuffer_nullterminate_u32,
    };
#endif

    static const struct UBufferDelegate ubuffer_scalar = {
        .append = &ubuffer_append_scalar,
        .nullterminate = &ubuffer_nullterminate_scalar,
    };

    unistat status = unicorn_check_output_encoding(text, capacity, &attributes);
    if (status == UNI_OK)
    {
        buf->storage = text;
        ...
        case UNI_UTF16:
            ...
            {
                buf->delegate = &ubuffer_u16le;
            }
            else
            {
                buf->delegate = &ubuffer_u16be;
            }
            break;
#endif
        ...
        case UNI_UTF32:
            if ((attributes & UNI_LITTLE) == UNI_LITTLE)
            {
                buf->delegate = &ubuffer_u32le;
            }
            else
            {
                buf->delegate = &ubuffer_u32be;
            }
            break;
#endif

        case UNI_SCALAR:
            buf->delegate = &ubuffer_scalar;
            break;
...
unistat ubuffer_finalize(struct UBuffer *buf)
{
    ...
    {
        buf->delegate->nullterminate(buf);
    }
...
{
    buf->delegate->append(buf, chars, chars_count);
