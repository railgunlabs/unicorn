...
int main(int argc, char *argv[])
{
    ...
    // or code units. It interprets precomposed and decomposed characters that
    // represent the same grapheme as equivalent.
    ...
    // prints the result. This approach is recommended when two strings are compared
    // in a one-off comparison check. If you'll be repeatedly comparing the same
    // strings over and over again, then the approach in the next fragment is preferred.
    ...
    // The following lines normalize two strings and compare the results.
