...
{
    // This code example compress text using the BOCU-1 compression algorithm.
    ...
    // The following function call compresses the input text 'src' and writes
    // the result to 'buf'. It's function signature is documented online at:
